  ...
  return (
        <section className='border-t bg-white py-16'>
          ...
          <div className='relative mx-auto max-w-5xl overflow-hidden rounded-lg border border-gray-200 shadow-xl'>
            {activeTab === "organize" && (<Image alt='Organize Applications' width={1200} height={800} src="/hero-images/hero1.png"  /> )}
           {activeTab === "hired" &&( <Image alt='Get Hired' width={1200} height={800} src='/hero-images/hero2.png'  /> )}
           {activeTab === "boards" &&( <Image alt='Manage Boards' width={1200} height={800} src='/hero-images/hero3.png'  /> )}
          </div>
          </div>
          </div></section>
  )
